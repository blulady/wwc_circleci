...
const SearchBox = (props) => {
    ...
    return (
        <div className={cx(styles["search-box"], "input-group")}>
            ...
            <input type="text" className={cx(styles["search-text"], "form-control border-left-0")} placeholder="Search For Name" aria-label="Search Box" onChange={onSearchChange} onBlur={onBlur} onFocus={onFocus} onKeyUp={onEnter} value={props.value}></input>
        </div>
    );
};
