...
describe('MessageBox', () => {
    test('it renders without crashing', () => {
        const { container } = render(<MessageBox type='Error' title='Sorry!' message='We could not process your request. \nPlease try again.' />);
    ...
    test('it renders correct styling for success', () => {
        const { container } = render(<MessageBox type='Success' title='Success!' message='Request Completed.' />);
        const typeDiv = container.querySelector('.message-box');
